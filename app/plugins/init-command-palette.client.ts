...
export default defineNuxtPlugin(() => {
    ...
    // Collect all initial commands to register them in batch
    const initialCommands: Parameters<typeof registerCommands>[0] = [];
    ...
    // Register all initial commands at once to trigger reactivity only once
