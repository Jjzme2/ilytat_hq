...
import type { Command } from '../../ilytat_common_packages/packages/ilytat-command-palette/composables/useCommandPalette'

export default defineNuxtPlugin(() => {
    const { registerCommands, open, toggle } = useCommandPalette();
