                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b border-white/5 last:border-0">
                            ...
                            <button 
                                ...
                                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                         ...
                         <div class="flex justify-between items-center py-2 border-b border-white/5 last:border-0">
                            ...
                            <button
                                ...
                                class="relative inline-flex h-6 w-11 items-center rounded-full bg-accent-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                            >
