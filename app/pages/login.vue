<template>
    <div class="bg-zinc-900 border border-white/5 rounded-2xl p-8 backdrop-blur-sm relative z-20 shadow-2xl">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input 
                        ...
                        placeholder="••••••••"
                    />
                    <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-white transition-colors">
            ...
            <div v-if="error" class="text-red-400 text-sm text-center bg-red-500/10 border border-red-500/20 p-2 rounded">
                {{ error }}
            </div>
