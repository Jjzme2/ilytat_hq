                ...
                <div class="flex items-start justify-between">
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                             <button @click="router.push('/projects')" class="text-zinc-500 hover:text-white transition-colors" aria-label="Back to projects">
                                    ...
                                    <div v-if="getSubtasks(task.id).length > 0" class="mt-3 ml-8 space-y-2 border-l-2 border-zinc-800 pl-3">
                                        ...
                                        >
                                            <button 
                                                ...
                                                :aria-label="sub.isCompleted ? 'Mark subtask incomplete' : 'Mark subtask complete'"
                                            >
