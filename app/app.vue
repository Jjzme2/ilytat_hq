<template>
  <div
    ...
    <Transition name="fade">
      <div v-if="!isAppReady"
        class="fixed inset-0 z-[100] bg-[#050505] flex flex-col items-center justify-center p-6 text-center overflow-hidden">
        <!-- Background Accents -->
        <div
          class="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-accent-primary/20 rounded-full blur-[150px] animate-pulse">
        </div>
        <div
          class="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-accent-secondary/15 rounded-full blur-[120px] animate-pulse [animation-delay:1s]">
        </div>
        ...
        <div class="relative z-10 space-y-8 animate-fade-in-up">
          <div class="flex flex-col items-center">
            <div
              ...
              <div
                class="absolute inset-0 bg-white/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all animate-pulse">
              </div>
            ...
            <div
              class="flex items-center gap-3 mt-2 text-accent-primary/80 font-black tracking-[0.3em] uppercase text-[10px]">
          ...
          <div class="space-y-4">
            <div class="flex flex-col items-center gap-2">
              <div class="w-48 h-1 bg-white/5 rounded-full overflow-hidden relative">
                <div
                  class="absolute inset-0 bg-gradient-to-r from-accent-primary to-accent-secondary animate-shimmer scale-x-[1.5]">
                </div>
              </div>
